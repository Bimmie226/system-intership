...
**Migrate** từ `KVM01(192.168.174.136)` sang `KVM02(192.168.174.137)` Thực hiện câu lệnh trên KVM01

```bash
virsh migrate --live ubuntu20.04 qemu+tcp://192.168.174.137/system
```

Sau khi quá trình hoàn tất, VM trên host KVM01 sẽ ở trạng thái Shutoff và VM chuyển sang host KVM02 ở trạng thái Running.

![alt text](../images/mig_10.png)

Ta mở VM ở trên KVM02 ta thấy lệnh ping 8.8.8.8 vẫn đang chạy

![alt text](../images/mig_11.png)


Sau khi chuyển qua KMV02, VM vẫn giữ nguyên IP và dữ liệu cũ

![alt text](../images/mig_12.png)