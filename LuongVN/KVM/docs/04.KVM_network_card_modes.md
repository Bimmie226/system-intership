...
- Với mô hình này máy ảo không thể nói chuyện với máy tính bên ngoài
- Nó chỉ có thể trao đổi với các máy trong cùng mạng bên trong server vật lý và trao đổi được với máy chủ vật lý

![alt text](../images/host_only_01.png)

### Cách cấu hình

Chọn `edit` -> `Connection Details`

![alt text](../images/host_only_02.png)

Chọn tab `Virtual Network` và click biểu tượng sau để thêm card mạng:

![alt text](../images/host_only_03.png)

Đặt tên cho card, sau đó chọn mode `isolated`, trong phần IPv4 ta cấu hình dải mạng cũng như range cấp IP 

![alt text](../images/host_only_04.png)

Sau khi tạo thành công, ta sẽ thấy mạng vừa tạo:

![alt text](../images/host_only_05.png)

# Nguồn tham khảo
https://github.com/doantan285/system-intership/blob/main/TanDV/13.KVM/03.KVM_network_card_modes/docs.md