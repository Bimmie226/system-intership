...
- [Mục lục](#mục-lục)
- [Cài đặt Prometheus và Grafana trên K8s sử dụng Prometheus Operator](#cài-đặt-prometheus-và-grafana-trên-k8s-sử-dụng-prometheus-operator)
  - [Bước 1: Cài đặt StorageClass cho Prometheus và Grafana](#bước-1-cài-đặt-storageclass-cho-prometheus-và-grafana)
  - [Bước 2: Thêm repo Helm của Prometheus và Grafana](#bước-2-thêm-repo-helm-của-prometheus-và-grafana)
  - [Bước 3: Kiểm tra trạng thái](#bước-3-kiểm-tra-trạng-thái)
