...
- [Alertmanager](#alertmanager)
  ...
  - [III. Cài đặt Alertmanager](#iii-cài-đặt-alertmanager)
    ...
    - [3.1 Cài đặt Alertmanager ở node ngoài cụm K8s](#31-cài-đặt-alertmanager-ở-node-ngoài-cụm-k8s)
...
- Ở đây, tôi sẽ expose Alertmanager ra ngoài bằng cách đổi type service từ `ClusterIP` thành `LoadBalancer`: 
...
```bash
devops@k8s-master-01:~/kube-prometheus-stack$ k get svc -n monitoring | grep alert
alertmanager-operated                            ClusterIP      None             <none>            9093/TCP,9094/TCP,9094/UDP      5d7h
kube-prometheus-stack-alertmanager               LoadBalancer   10.107.201.190   192.168.174.243   9093:32423/TCP,8080:30866/TCP   5d7h
```

- Truy cập trên browser: 

![alt text](../images/alert_01.png)

### 3.1 Cài đặt Alertmanager ở node ngoài cụm K8s 
