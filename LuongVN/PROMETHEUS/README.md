...
[1.0 Overview Prometheus](https://github.com/Bimmie226/system-intership/blob/main/LuongVN/PROMETHEUS/docs/01.Overview_Prometheus.md)

[1.1 Cài đặt Prometheus và Grafana trên K8s sử dụng Prometheus Operator](https://github.com/Bimmie226/system-intership/blob/main/LuongVN/PROMETHEUS/docs/02.Install_Prometheus_%26_Grafana_on_K8s.md)

[1.2 Cài đặt Node Exporter trên Rocky 9](https://github.com/Bimmie226/system-intership/blob/main/LuongVN/PROMETHEUS/docs/03.Install_Node_Exporter_On_Rocky9.md)
