...
- [Triển khai NextCloud sử dụng ingress-nginx vs MetalLB](#triển-khai-nextcloud-sử-dụng-ingress-nginx-vs-metallb)
- [Summary](#summary)
  - [I. Mô hình triển khai](#i-mô-hình-triển-khai)
  - [II. Phân hoạch địa chỉ IP](#ii-phân-hoạch-địa-chỉ-ip)
  - [III. Thực hiện](#iii-thực-hiện)
    - [3.0 Cài đặt metallb trên cụm k8s](#30-cài-đặt-metallb-trên-cụm-k8s)
    - [3.1 Cài đặt Ingress-Nginx trên cụm k8s](#31-cài-đặt-ingress-nginx-trên-cụm-k8s)
    - [3.2 Triển khai NextCloud](#32-triển-khai-nextcloud)
      - [3.2.0 Triển khai NFS-provisioner trên cụm k8s bằng helm](#320-triển-khai-nfs-provisioner-trên-cụm-k8s-bằng-helm)
      - [3.2.1 Deploy MariaDB](#321-deploy-mariadb)
      - [3.2.2 Deploy NextCloud](#322-deploy-nextcloud)
      - [3.2.3 Add Host](#323-add-host)
    - [3.3 Test](#33-test)


## I. Mô hình triển khai 

![alt text](../images/nextcloud_0.png)
...
### 3.0 Cài đặt metallb trên cụm k8s 
...
### 3.1 Cài đặt Ingress-Nginx trên cụm k8s 
...
### 3.2 Triển khai NextCloud 

#### 3.2.0 Triển khai NFS-provisioner trên cụm k8s bằng helm 
