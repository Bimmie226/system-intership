...
- [Mục Lục](#mục-lục)
- [Host network trong K8s](#host-network-trong-k8s)
  - [I. host network là gì ?](#i-host-network-là-gì-)
    - [1.0 Ví dụ về cách cấu hình Pod sử dụng hostNetwork](#10-ví-dụ-về-cách-cấu-hình-pod-sử-dụng-hostnetwork)
  - [II. Lab sử dụng Ingress Controller với hostNetwork](#ii-lab-sử-dụng-ingress-controller-với-hostnetwork)
    - [2.0 Bước 1:](#20-bước-1)
    - [2.1 Bước 2:](#21-bước-2)
    - [2.2 Bước 3:](#22-bước-3)
    - [2.3 Bước 4:](#23-bước-4)
    - [2.4 Bước 5:](#24-bước-5)
