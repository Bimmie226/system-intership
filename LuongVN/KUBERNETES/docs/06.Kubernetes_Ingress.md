...
- [Kubernetes Ingress](#kubernetes-ingress)
  - [I. Kubernetes Ingress là gì ?](#i-kubernetes-ingress-là-gì-)
  - [II. Tại sao cần dùng Kubernetes Ingress ?](#ii-tại-sao-cần-dùng-kubernetes-ingress-)
  - [III. Cơ chế hoạt động của Ingress](#iii-cơ-chế-hoạt-động-của-ingress)
  - [IV. Cấu trúc của Ingress Resource](#iv-cấu-trúc-của-ingress-resource)
    - [4.0 Ingress Rules](#40-ingress-rules)
    - [4.1 Path types](#41-path-types)
    - [4.2 Ví dụ về một kiến trúc triển khai sử dụng Ingress và LoadBalancer](#42-ví-dụ-về-một-kiến-trúc-triển-khai-sử-dụng-ingress-và-loadbalancer)
