...
## II#. High Availability hoạt động như thế nào ? 
...
### 2.0 Component Redundancy - Dự phòng thành phần 
...
### 2.1 Failover Machanism - Cơ chế chuyển đổi dự phòng 
...
### 2.3 Data Replication - Sao chép dữ liệu 
...
### 2.4 Monitoring & Heartbeat - Giám sát & Heartbeat
...
### 2.5 Ví dụ thực tế về High Availability 
